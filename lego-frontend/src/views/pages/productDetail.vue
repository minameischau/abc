            ...
            <div class="col-md-7">
                <div class="single-product-content">
                    ...
                    <!-- <div class="col-md-2 myt "> -->
                        <!-- <button type="button" class="cart-btn" style="" @click="submitAddToCart"> -->
                            <!-- <a href="#">BUY NOW</a>Thêm -->
                            <a href="" class="cart-btn" @click="submitAddToCart"><i class="fas fa-shopping-cart"></i> Add to cart</a>
                        <!-- </button> -->
                    <!-- </div> -->
                        ...
                        <p><strong>Categories: </strong> {{this.product.prod_category}}</p>
                    </div>
                    <h4>Share:</h4>
