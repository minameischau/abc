<template>
    <form class="inputs" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <input name="prod_name" type="text" class="form-control" v-model="this.FormProduct.prod_name" />
        </div>
        <div class="form-group">
            <label for="prod_category">Category at</label>
            <!-- <input name="prod_category" type="text" class="form-control" v-model="this.FormProduct.prod_category" /> -->
            <select name="" id="" v-model="this.FormProduct.prod_category">
                <option
        ...
        <div class="form-group">
            ...
            <input name="prod_desc" type="text" class="form-control" v-model="this.FormProduct.prod_desc" />
        </div>
        <div class="form-group">
            <label for="prod_price">Price</label>
            <input name="prod_price" type="text" class="form-control" v-model="this.FormProduct.prod_price" />
        </div>
        <div class="form-group">
            <label for="prod_quantity">Quantity</label>
            <input name="prod_quantity" type="text" class="form-control" v-model="this.FormProduct.prod_quantity" />
        </div>
        <div class="form-group">
            <label for="prod_img">Image</label>
            <input name="prod_img" type="file" @change="onChangeFile" class="form-control" />
        </div>

        <div class="form-group">
            <button class="btn btn-primary mr-4" type="submit" @click="createProduct(this.FormProduct)">Submit</button>
            <!-- Modal footer -->
            <!-- <div class=""> -->
...
export default {
    ...
    methods: {
        ...
        onChangeFile(e) {
            ...
            this.FormProduct.file = selectedFile;
        },
        ...
        AddProduct() {
            this.$emit("add:product", this.FormProduct);
        },
    },
    mounted() {
        this.refreshList();
