                    ...
                    <div class="col-lg-10 col-xl-8">
                      <div class="card w-100" style="border-radius: 10px;">
                        <div class="card-header w-100 px-4 py-4">
                          <h4 class="text-muted mb-0 text-center"><strong style="color: #F28123;">#{{this.order._id}}</strong></h4>
                        </div>
                        <div class="card-body w-100 p-4">
                          ...
                          <div class="d-flex justify-content-between pt-2">
                            <p class="text-muted mb-0">Recipient: {{this.order.name_user_receive}}</p>
                            <p class="text-muted mb-0"><span class="fw-bold me-4">Discount</span> 0.00</p>
                          </div>
              
                          <div class="d-flex justify-content-between">
                            <p class="text-muted mb-0">Order date-time : {{this.order.date_time}}</p>
                            <p class="text-muted mb-0"><span class="fw-bold me-4"></span> </p>
                          </div>
              
                          <div class="d-flex justify-content-between mb-5">
                            <p class="text-muted mb-0">Address : {{this.order.destination}}</p>
                            <p class="text-muted mb-0"><span class="fw-bold me-4">Delivery Charges</span> Free</p>
                          </div>
                        </div>
                        <div class="card-footer border-0 px-4 py-5"
                          style="background-color: #F28123; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
                          <h5 class="d-flex align-items-center justify-content-between text-white text-uppercase mb-0">
                            <span>Total paid: </span>
                            <span class="h2 mb-0 ms-2"> {{this.order.total_cost}}</span>
                          </h5>
                        </div>
                      </div>
                    </div>
