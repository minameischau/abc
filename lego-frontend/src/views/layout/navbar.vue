              ...
              <div class="main-menu-wrap">
                  ...
                  <div class="site-logo" >
                      ...
                      <router-link :to="{name: 'user.home'}">
                        ...
                        <!-- <h4 class="text-white">HNC</h4> -->
                        <img src="../../assets/assets/img/logo_hnc.png" alt="" style="width: 50%;">
                        ...
                        <li v-if="this.userId" >
                            <div class="header-icons">
                              <router-link :to="{
                                ...
                                <a class="mobile-hide search-bar-icon" href="#" @click="logout">Log out</a>
                        ...
                        <li v-else>
                            <div class="header-icons">
                              <router-link :to="{name: 'register'}">
                                <a class="shopping-cart" href="">Sign up</a>
                              </router-link> 
                              <router-link :to="{name: 'login'}">
                                <a class="mobile-hide search-bar-icon" href="#">Sign in</a>
                              </router-link> 
                            </div>
                        </li>
                    </ul>
